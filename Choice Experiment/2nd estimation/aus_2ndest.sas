PROC IMPORT OUT= WORK.full_data 
            DATAFILE= "E:\GM Project copy\Choice Experiment\Austria.Germany\Short\aus_
full.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
...
ods rtf file= 'E:\GM Project copy\Choice Experiment\2nd Estimation\Aus_results.rtf';
...
if q11_7 <3 then edu=1;
if q11_7 =3 then edu=2;
if q11_7=4 then edu=2;
if q11_7 >4 then edu=3;
